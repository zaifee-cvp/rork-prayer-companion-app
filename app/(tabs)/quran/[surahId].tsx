...
const styles = StyleSheet.create({
  ...
  bismillah: { fontSize: 26, textAlign: 'center' as const, marginBottom: 20, lineHeight: 42, fontWeight: fw.regular },
  ...
  arabicText: { textAlign: 'right' as const, fontWeight: fw.regular, marginBottom: 12, writingDirection: 'rtl' as const },
  ...
  translationText: { fontFamily: fontFamily.system, fontSize: 15, fontWeight: fw.regular, lineHeight: 22 },
});
